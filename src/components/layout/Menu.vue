...
const emit = defineEmits(["close", "open-groups-modal", "logout"]);
...
<template>
  <div
    ref="menuRef"
    class="absolute z-10 left-0 top-11 min-w-[200px] rounded-xl border border-gray-200 dark:border-[#242942] bg-[#f7f7f7] dark:bg-[#0f111c] shadow-xl shadow-black/5 dark:shadow-black/20 overflow-hidden flex flex-col py-1"
  >
    <div
