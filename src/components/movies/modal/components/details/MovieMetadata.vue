...
import MovieGenre from "@/components/movies/ui/MovieGenre.vue";
...
const releaseYear = computed(() => {
  if (!movie?.value?.release_date) return "Em breve";
...
<template>
  <div class="space-y-4">
    <div
      class="my-4 text-xs text-[#5E5E5E] dark:text-gray-300 flex items-center flex-wrap gap-x-2 gap-y-2"
    >
      <div
